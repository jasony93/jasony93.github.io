...
ADR 간 상호전환이 개시됐으며, 예탁은행은 씨티은행이다(인베스트조선
...
| TSMC | TSM (NYSE, ADR) | 2330 | 5 (ADR 1주 = 원주 5주) | https://www.fxbrokertrust.com/insights/tsmc-adr-vs-2330-conversion-premiums-and-costs |
...
장기간 유지되기도 한다( https://github.com/chungderson/tsmc-adr-premium ).
